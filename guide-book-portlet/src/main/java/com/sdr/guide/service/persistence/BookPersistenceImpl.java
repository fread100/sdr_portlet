...
import com.sdr.guide.NoSuchBookException;
import com.sdr.guide.model.Book;
import com.sdr.guide.model.impl.BookImpl;
import com.sdr.guide.model.impl.BookModelImpl;
...
public class BookPersistenceImpl extends BasePersistenceImpl<Book>
     ...
     */
    @Override
    public Book create(int gusetbookId) {
        Book book = new BookImpl();

        book.setNew(true);
        book.setPrimaryKey(gusetbookId);
     ...
     */
    @Override
    public Book remove(int gusetbookId)
        throws NoSuchBookException, SystemException {
        return remove((Serializable) gusetbookId);
    }
    ...
    @Override
    public Book updateImpl(com.sdr.guide.model.Book book)
    ...
    protected Book toUnwrappedModel(Book book) {
        ...
        bookImpl.setGusetbookId(book.getGusetbookId());
        bookImpl.setTitle(book.getTitle());
        bookImpl.setContent(book.getContent());
        ...
        bookImpl.setDeleteDate(book.getDeleteDate());
     ...
     */
    @Override
    public Book findByPrimaryKey(int gusetbookId)
        throws NoSuchBookException, SystemException {
        return findByPrimaryKey((Serializable) gusetbookId);
    }
     ...
     */
    @Override
    public Book fetchByPrimaryKey(int gusetbookId) throws SystemException {
        return fetchByPrimaryKey((Serializable) gusetbookId);
    }
    ...
    public void afterPropertiesSet() {
        String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
                    com.liferay.util.service.ServiceProps.get(
                        "value.object.listener.com.sdr.guide.model.Book")));
